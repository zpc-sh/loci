...
The project has inherited patterns from its prior form (`loci`) where AI-assisted contributions introduced uneven quality, especially in TUI and shell-facing code. This document establishes non-negotiable guardrails to prevent further drift.
