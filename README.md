...
1. Install MoonBit (`moon`):
   - Official guide: https://www.moonbitlang.com/
   - Unix-like systems (safer flow): `curl -fsSL -o moon-install.sh https://cli.moonbitlang.com/install/unix.sh`
   - Review installer: `less moon-install.sh`
   - Run installer: `bash moon-install.sh`
